...
let flat = (0, _flatpickrDefault.default)(inputRef, {
    enableTime: true,
    time_24hr: true,
...
function start() {
    const timer = setInterval(()=>{
        ...
        const timerEnd = "00";
        if (daysRef.textContent === timerEnd && hoursRef.textContent === timerEnd && minutesRef.textContent === timerEnd && secondsRef.textContent === timerEnd) clearInterval(timer);
    }, 1000);
    buttonRef.disabled = true;
// reload()
}
